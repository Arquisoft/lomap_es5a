...
router.post("/delete/:pointId", deletePoint); // elimina un punto del mapa
router.post("/review/:pointId", reviewPoint); // realiza una review sobre un punto cualquiera del mapa
