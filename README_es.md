...
[![Actions Status](https://github.com/arquisoft/lomap_es5a/workflows/CI%20for%20LOMAP_0/badge.svg)](https://github.com/arquisoft/lomap_es5a/actions)
...
Si quieres ejecutar el proyecto necesitarás [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) y [Docker](https://docs.docker.com/get-docker/). Asegúrate de tenerlos instalados en tu equipo. Descarga el proyecto con `git clone https://github.com/arquisoft/lomap_es5a`. La manera más rápida de ejecutar todo es con Docker.
...
- Documentación: https://github.com/arquisoft/lomap_es5a/tree/master/docs
