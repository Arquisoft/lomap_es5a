...
class EliminarAñadirAmigo_120users extends Simulation {
  ...
  private val scn = scenario("EliminarAñadirAmigo")
    .exec(
      http("request_0")
        .get("/profile/card")
        .headers(headers_0)
        .resources(
          ...
          http("request_17")
            .patch(uri5)
            .headers(headers_17)
            .body(RawFileBody("eliminarañadiramigo/0017_request.html")),
          http("request_18")
            .get("/profile/card")
            .headers(headers_18),
          http("request_19")
          ...
          http("request_36")
            .patch(uri5)
            .headers(headers_36)
            .body(RawFileBody("eliminarañadiramigo/0036_request.html")),
          http("request_37")
            .get(uri1)
            .headers(headers_37),
          http("request_38")
