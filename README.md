...
[![Actions Status](https://github.com/arquisoft/lomap_es5a/workflows/CI%20for%20LOMAP_ES5A/badge.svg)](https://github.com/arquisoft/lomap_es5a/actions)
...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es5a`. The fastest way to launch everything is with docker:
```bash
...
- Documentation: https://github.com/arquisoft/lomap_es5a/tree/master/docs
- Webapp: https://github.com/arquisoft/lomap_es5a/tree/master/webapp
- Restapi: https://github.com/arquisoft/lomap_es5a/tree/master/restapi
...
services:
  restapi:
    image: ghcr.io/arquisoft/lomap_es5a/restapi:latest
    ports:
      - "5000:5000"
  webapp:
    image: ghcr.io/arquisoft/lomap_es5a/webapp:latest
    ports:
      - "3000:3000"
    depends_on: 
      - restapi
...
deploy:
    ...
    - name: Deploy over SSH
      ...
      with:
        ...
        command: |
          wget https://raw.githubusercontent.com/arquisoft/lomap_es5a/master/docker-compose-deploy.yml -O docker-compose.yml
          docker-compose stop
          docker-compose rm -f
          docker-compose pull   
          docker-compose up -d
